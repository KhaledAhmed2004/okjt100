...
router.post('/', (0, auth_1.default)(user_1.USER_ROLES.SUPER_ADMIN), (0, validateRequest_1.default)(mosque_validation_1.MosqueValidation.createMosqueZodSchema), mosque_controller_1.MosqueController.createMosque);
router.patch('/:mosqueId', (0, auth_1.default)(user_1.USER_ROLES.SUPER_ADMIN), (0, validateRequest_1.default)(mosque_validation_1.MosqueValidation.updateMosqueZodSchema), mosque_controller_1.MosqueController.updateMosque);
