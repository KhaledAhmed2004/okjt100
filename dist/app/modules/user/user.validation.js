...
const createUserZodSchema = zod_1.z.object({
    body: zod_1.z
        ...
        email: zod_1.z
            ...
            .toLowerCase(),
        role: zod_1.z.enum([user_1.USER_ROLES.BROTHER, user_1.USER_ROLES.SISTER], { required_error: 'Role is required' }),
        revertDate: zod_1.z.string({ required_error: 'Revert date is required' }).datetime(),
...
exports.UserValidation = {
    ...
    getAllUserRolesZodSchema: zod_1.z.object({
        query: zod_1.z.object({
            ...
            role: zod_1.z.enum([user_1.USER_ROLES.SUPER_ADMIN, user_1.USER_ROLES.BROTHER, user_1.USER_ROLES.SISTER]).optional(),
            status: zod_1.z.enum([
                user_1.USER_STATUS.PENDING,
                user_1.USER_STATUS.ACTIVE,
                user_1.USER_STATUS.REJECTED,
