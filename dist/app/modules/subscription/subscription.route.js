...
router.get('/me', (0, auth_1.default)(user_1.USER_ROLES.BROTHER, user_1.USER_ROLES.SISTER, user_1.USER_ROLES.ADMIN, user_1.USER_ROLES.SUPER_ADMIN), subscription_controller_1.default.getMySubscriptionController);
...
router.post('/apple/verify', (0, auth_1.default)(user_1.USER_ROLES.BROTHER, user_1.USER_ROLES.SISTER, user_1.USER_ROLES.ADMIN, user_1.USER_ROLES.SUPER_ADMIN), (0, rateLimit_1.rateLimitMiddleware)({
    windowMs: 60000,
    max: 30,
...
router.post('/google/verify', (0, auth_1.default)(user_1.USER_ROLES.BROTHER, user_1.USER_ROLES.SISTER, user_1.USER_ROLES.ADMIN, user_1.USER_ROLES.SUPER_ADMIN), (0, rateLimit_1.rateLimitMiddleware)({
    windowMs: 60000,
    max: 30,
...
router.post('/choose/free', (0, auth_1.default)(user_1.USER_ROLES.BROTHER, user_1.USER_ROLES.SISTER, user_1.USER_ROLES.ADMIN, user_1.USER_ROLES.SUPER_ADMIN), subscription_controller_1.default.chooseFreePlanController);
// --- Admin Routes ---
router.get('/admin', (0, auth_1.default)(user_1.USER_ROLES.SUPER_ADMIN, user_1.USER_ROLES.ADMIN), subscription_controller_1.default.getAllSubscriptionsController);
router.get('/admin/analytics', (0, auth_1.default)(user_1.USER_ROLES.SUPER_ADMIN, user_1.USER_ROLES.ADMIN), subscription_controller_1.default.getSubscriptionAnalyticsController);
router.get('/admin/pending-webhooks', (0, auth_1.default)(user_1.USER_ROLES.SUPER_ADMIN, user_1.USER_ROLES.ADMIN), subscription_controller_1.default.getPendingWebhooksController);
router.get('/admin/:id', (0, auth_1.default)(user_1.USER_ROLES.SUPER_ADMIN, user_1.USER_ROLES.ADMIN), subscription_controller_1.default.getSubscriptionByIdController);
